...
export function InvoiceFooter({ agencyInfo }: InvoiceFooterProps) {
  ...
  return (
    <div className="mt-4 pt-2 border-t border-gray-200 print:mt-1 print:pt-1">
      <div className="text-center text-gray-500 text-sm print:text-xs space-y-0.5">
        <p className="font-medium text-gray-600 print:text-[10px]">{t("thankYou")}</p>
        <div className="pt-0.5 print:text-[9px]">
          <p>{agencyInfo.name}</p>
