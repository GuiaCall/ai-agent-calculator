...
export const fr = {
  translation: {
    ...
    "aiAgentMenu": "Menu d'Agent IA",
    "allRightsReserved": "Tous droits réservés.",
    "calculator": "Calculateur",
    "dashboard": "Tableau de Bord",
    "logout": "Déconnexion",
    "loggedOutSuccessfully": "Déconnecté avec succès",
    "loggedOutMessage": "Vous avez été déconnecté de votre compte",
    "errorLoggingOut": "Erreur de déconnexion",
    "errorLoggingOutMessage": "Une erreur s'est produite lors de la déconnexion. Veuillez réessayer.",
    ...
    "pricingDescription": "Choisissez le plan qui convient le mieux à vos besoins",
